...
if (!defined('SMARTY_DIR')) {
    define('SMARTY_DIR', dirname(\ProcessWire\wire("config")->paths->root . 'site/modules/TemplateEngineSmarty/smarty/libs/Smarty.class.php') . DS);
}
...
if (!class_exists('Smarty_Autoloader', false)) {
 ...
 require_once(\ProcessWire\wire('files')->compile(dirname(\ProcessWire\wire("config")->paths->root . 'site/modules/TemplateEngineSmarty/smarty/libs/Smarty.class.php') . '/Autoloader.php',array('includes'=>true,'namespace'=>true,'modules'=>false,'skipIfNamespace'=>false)));
...
if (!class_exists('Smarty_Internal_Data', false)) {
 require_once(\ProcessWire\wire('files')->compile(SMARTY_SYSPLUGINS_DIR . 'smarty_internal_data.php',array('includes'=>true,'namespace'=>true,'modules'=>false,'skipIfNamespace'=>false)));
}
 require_once(\ProcessWire\wire('files')->compile(SMARTY_SYSPLUGINS_DIR . 'smarty_internal_extension_handler.php',array('includes'=>true,'namespace'=>true,'modules'=>false,'skipIfNamespace'=>false)));
 require_once(\ProcessWire\wire('files')->compile(SMARTY_SYSPLUGINS_DIR . 'smarty_internal_templatebase.php',array('includes'=>true,'namespace'=>true,'modules'=>false,'skipIfNamespace'=>false)));
 require_once(\ProcessWire\wire('files')->compile(SMARTY_SYSPLUGINS_DIR . 'smarty_internal_template.php',array('includes'=>true,'namespace'=>true,'modules'=>false,'skipIfNamespace'=>false)));
 require_once(\ProcessWire\wire('files')->compile(SMARTY_SYSPLUGINS_DIR . 'smarty_resource.php',array('includes'=>true,'namespace'=>true,'modules'=>false,'skipIfNamespace'=>false)));
 require_once(\ProcessWire\wire('files')->compile(SMARTY_SYSPLUGINS_DIR . 'smarty_variable.php',array('includes'=>true,'namespace'=>true,'modules'=>false,'skipIfNamespace'=>false)));
 require_once(\ProcessWire\wire('files')->compile(SMARTY_SYSPLUGINS_DIR . 'smarty_template_source.php',array('includes'=>true,'namespace'=>true,'modules'=>false,'skipIfNamespace'=>false)));
 require_once(\ProcessWire\wire('files')->compile(SMARTY_SYSPLUGINS_DIR . 'smarty_template_resource_base.php',array('includes'=>true,'namespace'=>true,'modules'=>false,'skipIfNamespace'=>false)));
